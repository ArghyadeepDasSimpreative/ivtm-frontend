            ...
            <nav className="sticky top-0 z-50 bg-slate-900 shadow-md border-b border-slate-800 h-[73px] flex items-center px-8">
                <div className="flex justify-between items-center w-full">
                    ...
                    <div className="flex justify-between gap-10 items-center">
                        <Link to="/roadmap-analysis" className="text-gray-300 hover:text-red-400 font-medium transition-colors">Home</Link>
                        <button
                            onClick={() =>
                                handleLogout()
                            ...
                            className="text-gray-300 hover:text-red-400 font-medium transition-colors cursor-pointer"
                        >
                            Log out
                        </button>
                    </div>
